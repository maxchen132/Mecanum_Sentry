...
void Board_A_IMU_Calc_Angle(Board_A_IMU_t *Board_A_IMU)
{
    ...
    Board_A_IMU->Export_Data.Gyro_Yaw = Board_A_IMU->Calc_Data.Gx;   // degree/s to RPM
    Board_A_IMU->Export_Data.Gyro_Pitch = Board_A_IMU->Calc_Data.Gy; // degree/s to RPM
    Board_A_IMU->Export_Data.Gyro_Roll = Board_A_IMU->Calc_Data.Gz;  // degree/s to RPM
