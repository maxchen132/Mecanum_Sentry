...
void M3508_Fric_Wheel_Send_Data(int16_t Fric_Wheel_Left_Up_Current, int16_t Fric_Wheel_Left_Down_Current,
								int16_t Fric_Wheel_Right_Up_Current, int16_t Fric_Wheel_Right_Down_Current);
...
void M3508_Chassis_Speed_TO_Current()
{
}
...
void M3508_Fric_Wheel_Get_Data(CAN_Export_Data_t RxMessage)
{
	...
	{
	case M3508_FRIC_WHEEL_LEFT_UP_ID:
		...
		break;
	case M3508_FRIC_WHEEL_LEFT_DOWN_ID:
		...
		break;
	case M3508_FRIC_WHEEL_RIGHT_UP_ID:
		...
		break;
	case M3508_FRIC_WHEEL_RIGHT_DOWN_ID:
		M3508_Fric_Wheel[3].Actual_Angle = (int16_t)(RxMessage.CANx_Export_RxMessage[0] << 8 | RxMessage.CANx_Export_RxMessage[1]);
		M3508_Fric_Wheel[3].Actual_Speed = (int16_t)(RxMessage.CANx_Export_RxMessage[2] << 8 | RxMessage.CANx_Export_RxMessage[3]);
		M3508_Fric_Wheel[3].Actual_Current = (int16_t)(RxMessage.CANx_Export_RxMessage[4] << 8 | RxMessage.CANx_Export_RxMessage[5]);
		M3508_Fric_Wheel[3].Temperature = RxMessage.CANx_Export_RxMessage[6];

		M3508_Fric_Wheel[3].Info_Update_Frame++;
		break;
	}
}

// Send friction wheel data through specified identifier
void M3508_Fric_Wheel_Send_Data(int16_t Fric_Wheel_Left_UP_Current,
								int16_t Fric_Wheel_Left_DOWN_Current,
								int16_t Fric_Wheel_RIGHT_UP_Current,
								int16_t Fric_Wheel_Right_DOWN_Current)
{
	CAN_Func.CAN_0x200_Send_Data(&hcan2, Fric_Wheel_Left_UP_Current,
								 Fric_Wheel_Left_DOWN_Current,
								 Fric_Wheel_RIGHT_UP_Current,
								 Fric_Wheel_Right_DOWN_Current);
}
